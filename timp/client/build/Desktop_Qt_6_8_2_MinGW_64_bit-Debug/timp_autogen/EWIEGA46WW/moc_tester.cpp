...
static constexpr auto qt_meta_stringdata_ZN6TesterE = QtMocHelpers::stringData(
    "Tester"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6TesterE[] = {
...
Q_CONSTINIT const QMetaObject Tester::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6TesterE.offsetsAndSizes,
    qt_meta_data_ZN6TesterE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6TesterE_t,
        // Q_OBJECT / Q_GADGET
...
void *Tester::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6TesterE.stringdata0))
